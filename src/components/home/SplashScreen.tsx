    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="fixed inset-0 z-[100] bg-[#283959] flex items-center justify-center overflow-hidden"
        >
          <video
            autoPlay
            muted
            ...
            className="w-full h-full object-contain md:object-cover bg-[#283959]"
